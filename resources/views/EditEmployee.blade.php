    ...
    <body class="bg-black">
        <div class="container-fluid px-5 ">
            <div class=" p-5 mt-4 rounded shadow-lg bg-body-light position-relative">
                ...
                <form class="row" id="submit_form" data-id="{{ $data->id }}">
                    @csrf
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-2">
                            ...
                            <input type="number" class="form-control" value="{{ $data->mobile_number }}"
                                name="mobile_number" id="mobile_number" placeholder="Enter Mobile Number">
                    ...
                    <div class="col-12">
                        <button class="btn btn-warning px-3 fw-bold float-end">Update</button>
                    </div>
                </form>
                {{-- toast notification --}}
                <div class="toast align-items-center bg-white position-absolute top-0 start-50 translate-middle"
                    id="liveToast" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="4000">
                    <div class="d-flex">
